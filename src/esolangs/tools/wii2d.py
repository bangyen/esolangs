...
# points via the popcount chain. The relevant tests cover the
# measured
...
# a sample. The relevant tests cover the resampled build and
# refusal curves.
#
...
# one that does not. The relevant tests cover both figures and why
