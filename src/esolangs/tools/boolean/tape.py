...
#: measured worst case at ten inputs -- n=10 parity encodes to 454832
#: digits, n=10 dense to 328772 -- so this clears the whole reach of the
#: construction with room and still names a ceiling rather than removing
