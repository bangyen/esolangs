...
# boolean generator is parameterized and termination-based (halt = 0, hang =
# 1), so its committed AND2 is the template instantiated for a 00 input,
# which halts (no output).  ArrowQueue
...
BOOLEAN_EXAMPLES = {
    ...
    "dotlang": ("grid_based.dotlang", [], "", True),
