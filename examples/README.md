...
`hello-world/` contains text-generator examples. `boolean/` contains one
end-to-end Boolean example per selected language; input-reading programs take
`0`/`1` lines, while parameterized programs embed the row's bits.
