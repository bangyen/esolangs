...
form a Chebyshev system, because their Wronskian
$e^{(\sum_i\lambda_i)d}\prod_{i<j}(\lambda_j-\lambda_i)$ is nowhere
zero~\cite[Chapter~I, Theorem~4.1]{karlin-studden}.  Equivalently, prove the
