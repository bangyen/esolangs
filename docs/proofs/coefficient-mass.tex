...
(Section~\ref{sec:rootfour} lowers $\frac92$ to $4$).
...
once (Corollary~\ref{cor:rootfourfinite}).
...
The ranges should extend to all $n$, but we have no proof.  In floating
...
$n$ exactly for $r$ above about $3.2$.  A proof for all $n$ along these lines
would need a two-parameter version of Steps~4 and~5.  The worst largest zero is
