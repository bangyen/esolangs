...
How much better, we do not know.  Minimizing $b_k$ over monic multipliers of
bounded degree is a linear program for $k=1$ and a mixed-integer program for
$k\ge2$; at degree at most $18$, with the indicator cutoff raised until it
stopped binding, the least values found are
\begin{center}
\begin{tabular}{lcrrr}
\hline
roots & $k$ & $\prod_{i=k}^L(r_i-1)$ & least $b_k$ & ratio\\
\hline
$(2,3)$   & 1 & $2$  & $3.333$  & $1.667$\\
          & 2 & $2$  & $2.000$  & $1.000$\\
$(3,5)$   & 1 & $8$  & $8.000$  & $1.000$\\
          & 2 & $4$  & $4.001$  & $1.000$\\
$(5,7)$   & 1 & $24$ & $24.000$ & $1.000$\\
          & 2 & $6$  & $6.077$  & $1.013$\\
$(2,3,5)$ & 1 & $8$  & $14.588$ & $1.824$\\
          & 2 & $8$  & $8.008$  & $1.001$\\
          & 3 & $4$  & $4.032$  & $1.008$\\
\hline
\end{tabular}
\end{center}
Each entry is read off an actual multiple, so it bounds the infimum above.  The
rows $k\ge2$ sit within $1.3\%$ of $\prod_{i=k}^L(r_i-1)$ throughout, while
row $k=1$ misses by a factor $1.82$ at $(2,3,5)$; its entry at $(2,3)$ is the
$10/3$ just proved.  Whether the rows $k\ge2$ are sharp in order is open.
