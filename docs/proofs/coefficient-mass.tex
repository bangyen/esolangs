...
sectors that contain a real direction.  What remains open is the capped
hypothesis for $\frac12\le c<1$ in sectors inside an open half-plane.
...
to precision $\rho^{-cs}$.  We do not know a proof in any range of $c$.
