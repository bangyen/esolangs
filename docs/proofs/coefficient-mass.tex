...
$\sum_jj\log\rho_j$, for pairs $a_j\pm ic_j\in\mathbb Z[i]$ with $0<|a_j|<c_j$
and general $K$.  By Corollary~\ref{cor:gaussfinite} a mass bound $X$ needs to
...
get only the first row from Theorem~\ref{thm:padicmass}.  Carry sizes, even
...
the question is a uniform statement in $K$.
