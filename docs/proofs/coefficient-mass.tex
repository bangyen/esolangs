...
The $u=0$ clause is Lemma~\ref{lem:slack}'s, its perturbation run with distinct
$r_{i,\varepsilon}>1$.
\end{proof}
...
gives at $u=1$ and $u=2$; we omit the verification.  Whether the rows
$k\ge2$ are sharp in general is open.
