...
\[
  b_1\ge10/3
\]
for every monic multiple, against $|P(1)|=2$.  This is also why the rows
$k\ge2$ fare better: there the excluded positions force the zero set off the
consecutive one.
...
row $2$ is an infimum, while row $1$ understates by a factor of at least
$5/3$.
