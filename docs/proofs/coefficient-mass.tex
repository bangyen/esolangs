...
Two limits are worth stating plainly.  Every result above requires
$r_i\ge2$, and the restriction is not an artifact of the proof but of the
statement: by Proposition~\ref{prop:subtwo}, \eqref{eq:order} is false for
...
against $8$ and $\min b_3=4.122$ against $4$---so the gap there, if any, is
small.
