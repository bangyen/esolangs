...
outright: the infimum of $b_2$ over monic multiples is exactly the bound.
...
$6.5\%$ of \eqref{eq:order}; for $(2,3)$ it returns $2.0308$, the degree-$8$
member of the family above.  These are floating-point optima at a degree cap,
