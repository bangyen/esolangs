...
this tends to $5$ as $R\to\infty$, while $(\rho_1-1)(\rho_2-1)=1$.  Second,
...
\end{equation}
The row $k=1$ is Proposition~\ref{prop:rowone}, and the row $k=2$ holds up to
the factor $65$ (Theorem~\ref{thm:secondrow}); for roots of one sign
