...
particular there are no other zeros.  Here the $q+1$ units in a gap are
counted with multiplicity; the parity supplies one unit beyond the $q$ forced
ones, possibly at a forced zero.
