...
\subsection{All rows at roots at least \texorpdfstring{$\frac92$}{9/2}}\label{sec:bigroot}
...
\subsection{All rows at roots at least \texorpdfstring{$4$}{4}}\label{sec:rootfour}
...
\subsection{All rows at roots at least \texorpdfstring{$\frac{25}7$}{25/7}}\label{sec:rootbelowfour}
