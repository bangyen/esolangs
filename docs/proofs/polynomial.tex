...
\hypersetup{
  ...
  pdftitle={The Worst-Case Text Complexity of the Polynomial Language},
...
\]
Plainly $|f|\ge M(f)$.  Let worst-case text complexity mean the
maximum, over these tables, of the minimum $|f|$ of a program computing it.
...
bounded search is used as a premise.  The reviewed source is archived at
...
all companion manuscripts and \texttt{just test} runs the branch verification
gate.
...
multiples,
\newblock companion manuscript, September 2026; Theorem~3.2
(Logarithmic mass).
