...
at each of $139$ further integer root sets we tried with $u\le2$.  Two things
are not proved in general: that $\tau^*$ is attained by a full certificate
with a witness as in \eqref{eq:dualpair}, and that the search always closes,
that is, that the escaping placement is always extremal.  Repeated roots
