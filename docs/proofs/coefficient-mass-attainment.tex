...
coefficient bound; Corollary~3.7 sharpens the resulting asymptotic to an
...
\eqref{eq:order}.  Corollary~3.7 settles the asymptotic form of
...
certificate), Theorem~3.2 (Coefficient order statistics), Corollary~3.7
