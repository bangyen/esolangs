...
$b_2$ decreases to $2$~\cite[Proposition~4.5]{coefficient-mass}, so the $u=1$
...
Lemma~3.1 (Slack certificate), Theorem~3.2 (Coefficient order statistics),
Proposition~4.5 (Sharpness of the row $k=2$ at $(2,3)$).
\end{thebibliography}
