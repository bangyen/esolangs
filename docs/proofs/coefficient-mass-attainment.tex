...
exact infimum for the first $L$ primes.  Throughout, an unqualified Lemma~2.1,
...
minimizes $\ell^1$ over normalized multiples~\cite{schinzel}, the minimal Euclidean
...
the aggregated question for prime roots, and the multiplier $x+1$
of~\cite[Section~3]{coefficient-mass} shows
that even there the root product need not be the finite-$L$ minimizer.  For
the root pair $(2,3)$ and $k=2$, \cite[Proposition~4.1]{coefficient-mass}
