...
multiple's head exceeds its $c$ by a factor above four.
...
\[
  ...
  \qquad
  \inf_Qb_3\Bigl(Q\prod_{r=2}^7(x-r)\Bigr)=\frac{114840}{259}=443.397\ldots,
\]
...
that the escaping placement is always extremal.  By
Proposition~\ref{prop:head} the second is, at each placement, a bound on
$\max X-1$ coefficients of a deflated multiple.  Repeated roots
beyond the confluent pair $(3,3)$ also remain open.
