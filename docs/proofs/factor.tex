...
to ensure an unlimited supply of instruction primes.  Here the issue is
instead decimal description length: the upper bound needs quantitative
control of successive instruction primes, while the lower bound counts all
encodings, including those with ignored factors.
...
\]
The fixed node gadgets and the single final output add $O(T)$.  This proves
existence independently of any implementation; the public generator also
considers this construction.
\end{proof}
...
language lower bound above.  The reviewed source is archived at
