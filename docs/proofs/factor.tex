...
The Boolean generator first emits a Brainfuck decision tree of length
$C=O(T)$ and then replaces each maximal run by one prime power.  It scans
...
\begin{proof}
There are at most $C$ runs.  By Lemma~\ref{lem:adaptive},
