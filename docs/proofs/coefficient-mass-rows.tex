...
first bounds.  The next sections treat the rows below $2$ through prefix
sets, several roots, hole shifts, finite certificates, monotone prefix values
and crossing.  Sections~\ref{sec:allrowstwo}, \ref{sec:onepoly}
and~\ref{sec:longdiag} contain the main theorems.  Appendix~\ref{sec:holeproducts}
collects bounds on the hole products of top-row optima.
...
\section{Rows below two, at several roots, and rows equal to the top row}
...
\section{Moving holes at several roots, and inserting into sets with few holes}
...
\section{All rows at every root at least \texorpdfstring{$2$}{2}}\label{sec:allrowstwo}
...
\section{Long diagonals below the root \texorpdfstring{$2$}{2}}\label{sec:longdiag}
