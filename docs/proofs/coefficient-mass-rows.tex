...
optimal for all prefix problems at once.  The prefix identity~\eqref{eq:prefixid} holds at $(r,n,k)$ whenever
...
\]
So the prefix identity~\eqref{eq:prefixid} holds at $(r,n)$
...
grows, and for $n=1$ it is $(1,2]$.  It is nonempty for every $n$.
