...
The latest release on PyPI and the current `main` branch.
...
Report privately through GitHub's [security advisory form](https://github.com/bangyen/esolangs/security/advisories/new), not a public issue.

Please include the language, the smallest program that shows it, the commit or released version, and what the program achieved that it should not have been able to.
