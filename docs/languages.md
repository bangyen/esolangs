...
column marks the boolean-function generators; Back, BIO, Eval, NoComment's, and Dotlang are parameterized (the harness substitutes input bits into a template).
