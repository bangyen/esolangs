...
`examples/hello-world/` holds a "Hello, World!" for each language with a
text generator, and `examples/boolean/` holds a truth-table program for
each language with a boolean generator.  Both sets are regenerated by
